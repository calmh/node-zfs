...
/*
*
*  Mount the specified dataset to the mountpoint (have been set before mount)
*
*  PARAMS:
*  opts: {
*    dataset: string // the name of the zfs dataset. if the dataset is null, then mount all filesystem with '-a'
